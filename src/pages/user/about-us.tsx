...
export const AboutUs: FC = (): ReactElement => {
  const teams = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1615109398623-88346a601842?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      alt: "Field Marketing",
    },
    {
      name: "Dida",
