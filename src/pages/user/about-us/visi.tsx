...
export const Visi: FC = (): ReactElement => {
  return (
    <section className="flex h-[45%] w-full flex-col items-center justify-evenly">
      <section className="container flex w-full flex-col items-center justify-center gap-7">
        ...
        <img
          ...
          alt="about us"
          className="scale-95 object-cover pt-5"
        />
      </section>
