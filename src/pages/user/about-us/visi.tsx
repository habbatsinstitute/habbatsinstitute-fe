...
export const Visi: FC = (): ReactElement => {
  return (
    <section className="flex h-[45%] w-full flex-col items-center justify-evenly pt-10">
      ...
      <h2 className="mx-auto w-[70%] text-center text-[1.1rem]">
        Selain itu mimpi kami adalah menjadi leader pasar dalam penyedia produk
        herbal habbatussauda baik di pasar domestik maupun regional bahkan
        internasional.
      </h2>
      <img
      ...
      <section className="flex w-full">
        <section className="flex h-full w-1/2 flex-col justify-center gap-3 pl-[5%]">
          ...
          <p className="text-font-black-2 w-[70%]">
            ...
            langsung agar tetap menjaga ikatan antara konsumen dengan principle
            melalui after sales service yang baik.
          </p>
        </section>
        <section className="grid h-full w-1/2 place-items-center">
          <img
